...
const ActiveSlider = () => {
    return (
      <div className="flex items-center justify-center flex-col auto bg-black">
        <Swiper
          loop={true}
          autoplay={{
            delay: 2000,
        ...
        >
          {ServiceData.map((item, index) => (
            <SwiperSlide key={item.index}>
              <div className="flex flex-col group relative px-6 py-8 shadow-lg h-[150px] w-[215px] lg:h-[300px] lg:w-auto overflow-hidden cursor-pointer">
                <div
